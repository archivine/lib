                ...
                function Tab:AddGroupBox(Name, Side)
                    ...
                    do
                        function Groupbox:AddToggle(Title)
                            ...
                            do
                                Toggle["1"].MouseEnter:Connect(
                                    function()
                                        Toggle.Hover = true
                                    end
                                )

                                Toggle["1"].MouseLeave:Connect(
                                    function()
                                        Toggle.Hover = false
                                    end
                                )
                        ...
                        function Groupbox:AddSlider(Title, MinValue, MaxValue, Options)
                            ...
                            do
                                ...
                                function Slider:Update()
                                    local X =
                                        math.ceil(
                                        Slider:Map(Slider.CurrentValue, MinValue, MaxValue, 0, Slider.MaxSize)
                                    )
        ...
        function Window:Hook()
            UIS.InputBegan:Connect(
                function(Input)
                    ...
                    -- Drag
                    do
                        Window["6"].MouseEnter:Connect(
                            function()
                                Window.DragHover = true
                            end
                        )

                        Window["6"].MouseLeave:Connect(
                            function()
